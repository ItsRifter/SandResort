...
public struct NPCDebugDraw
{
	...
	public NPCDebugDraw( float duration, Color color, bool depth )
	{
	...
	public NPCDebugDraw WithColor( Color color )
	{
		var t = this;
		t.Color = color;
		return t;
	...
	public NPCDebugDraw WithSettings( float duration )
	{
		var t = this;
		t.Duration = duration;
		return t;
	...
	public NPCDebugDraw WithDuration( float duration )
	{
		var t = this;
		t.Duration = duration;
		return t;
	...
	public NPCDebugDraw WithSettings( float duration, Color color, bool depth )
	{
		return new NPCDebugDraw( duration, color, depth );
	}

	public NPCDebugDraw IgnoreDepth()
	{
		var t = this;
		t.DepthTest = false;
		return t;
