...
public partial class FlatscreenTV : PHSuiteProps
{
	...
	public override string SuiteItemImage => "ui/sc_icon_tv_flatscreen.png";
	public override Model WorldModel => Model.Load( "models/television/flatscreen/flatscreen_tv_standing.vmdl" );
